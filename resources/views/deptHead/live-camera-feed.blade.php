    ...
    <div id="cameraGridView" class="camera-grid">
        @forelse($cameras as $camera)
            <div class="camera-feed" onclick="showCameraDetail('{{ $camera->camera_id }}')">
                ...
                <video id="webrtc-player-{{ $camera->camera_id }}" autoplay playsinline muted
        ...
        @empty
            <div
                style="grid-column: 1 / -1; background:#fff; border-radius:10px;
            ...
            <div class="combined-card">
                ...
                <div class="combined-card-content">
                    ...
                    <div class="faculty-image-container">
                        <img id="faculty-image" class="faculty-image" src="" alt="Faculty Image"
                            style="display: none;">
...
@section('scripts')
    <script>
        ...
        async function startWebRTC(camera, detail = false) {
            ...
            try {
                ...
                const response = await fetch(
                    `${WEBSOCKET_HOST}/offer/${camera.camera_id}?mode=${detail ? "detail" : "grid"}`, {
                        method: "POST",
                        headers: {
        ...
        function getCurrentLoadForRoom(roomNo) {
            ...
            const todaysLoads = teachingLoads.filter(tl => tl.room_no == roomNo && tl.teaching_load_day_of_week ===
            dayName);
        ...
        function updateSchedulePanel(camera) {
            ...
            if (load) {
                ...
                document.getElementById('schedule-course').textContent =
                    `${load.teaching_load_course_code} ${load.teaching_load_subject}`;
        ...
        function updateFacultyImage(faculty) {
            ...
            console.log('Faculty images length:', faculty.faculty_images ? faculty.faculty_images.length :
                'No faculty_images property');
        ...
        function showCameraDetail(cameraId) {
            ...
            document.getElementById('lab-building').textContent =
                `ROOM: ${camera.room_name} / BUILDING: ${camera.room_building_no}`;

    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <div class="sub-nav" id="files-subnav" @if (trim($__env->yieldContent('files-active')) == 'active') style="display:flex;" @endif>
                <div class="sub-nav-item @yield('faculty-account-active')"
                    onclick="window.location.href='{{ route('deptHead.faculty.account.management') }}'">Faculty
                    Management</div>
                <div class="sub-nav-item @yield('subject-active')"
                    onclick="window.location.href='{{ route('deptHead.subject.management') }}'">Subject Management</div>
               <div class="sub-nav-item @yield('teaching-load-active')"
                    onclick="window.location.href='{{ route('deptHead.teaching.load.management') }}'">Teaching Load
                </div>
            </div>
            ...
            <div class="sub-nav" id="monitoring-subnav" @if (trim($__env->yieldContent('monitoring-active')) == 'active' ||
                ...
                <div class="sub-nav-item @yield('rooms-active')"
                    onclick="window.location.href='{{ route('deptHead.room.management') }}'">Rooms</div>
            ...
            <div class="nav-item @yield('reports-active')"
                onclick="window.location.href='{{ route('deptHead.attendance.records') }}'">
                <span class="nav-icon" style="display:inline-flex;align-items:center;justify-content:center;">
                    <svg width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="3" y="5" width="16" height="14" rx="2" stroke="#fff"
                            stroke-width="2" />
    ...
    <div id="accountSettingsModal" class="modal-overlay profile-modal" style="display:none;">
        <div class="modal-box">
            ...
            <form id="accountSettingsForm" class="modal-form" method="POST"
                action="{{ route('deptHead.account.update') }}">
                @csrf
                @method('PUT')
